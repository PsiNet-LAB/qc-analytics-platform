...
La arquitectura actual está optimizada para el monitoreo del macro-proyecto de adaptación cultural para poblaciones quechuahablantes (variante Chanka) en el Perú, abarcando escalas clínicas y de bienestar como **FACES-IV, PANAS, PHQ-9, SWLS, AUDIT y BFI-15**.
